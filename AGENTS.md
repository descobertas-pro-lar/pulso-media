...
Read README.md and strategy/editorial-strategy.md first. Also read strategy/post-formats.md (canonical layout guide), strategy/cctv-post-template.md, strategy/scam-post-template.md, operations/buffer-publishing.md, operations/morning-automation.md, the relevant editorial/calendar/ weekly plan, and editorial/published/ records before posting work. strategy/growth-experiment-10k.md is a proposal, not adopted policy.
