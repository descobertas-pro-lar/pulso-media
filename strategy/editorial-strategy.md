...
- Video branding (approved September 8): use only a bottom navy bar with off-white @PulsoBrasil and green/yellow diagonal accents. Append it below the footage; preserve the full image and source credits. No top branding or side border. See assets/brand/README.md for palette and reusable asset. Show the final branded version in approval previews.
