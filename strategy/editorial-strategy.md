...
- Audience: Brazilian Portuguese readers interested in crime footage, exposed scams, related news and politics across Brazil. The user clarified that this is an interest-led national account, not primarily a local news service.
...
- Video branding (latest user direction, September 8): center a low-opacity watermark containing the PB logo plus @PulsoBrasil over the footage. This supersedes the previous top/bottom bars. Start at 20% opacity as an adjustable implementation default; preserve frame dimensions, source credits and timestamps. Follow assets/brand/video-branding.md and show the final watermark in approval previews. Preserve published files and URLs.
